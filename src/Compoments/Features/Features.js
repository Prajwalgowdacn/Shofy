          ...
          <div className="tp-feature-inner-2">
            <div className="row align-items-center">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="tp-feature-item-2 d-flex align-items-start  border p-3">
                  ...
                  <div className="tp-feature-content-2">
                    <h3 className="tp-feature-title-2  mx-2">Free Delivery</h3>
                    <p className="mx-3">Orders from all items</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="tp-feature-item-2 d-flex align-items-start border p-3">
                  ...
                  <div className="tp-feature-content-2">
                    <h3 className="tp-feature-title-2 mx-2">Return & Refund</h3>
                    <p className="mx-3">Money back guarantee</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="tp-feature-item-2 d-flex align-items-start border p-3" >
                  ...
                  <div className="tp-feature-content-2">
                    <h3 className="tp-feature-title-2 mx-3">Support 24/7</h3>
                    <p className='mx-2'>Contact us 24 hours a day</p>
                  </div>
                </div>
              </div>
            </div>
